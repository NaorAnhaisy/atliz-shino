    ...
    return (
      <div className="terms-privacy">
        ...
        <ul>
          ...
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Atliz Shino, St. Jerusalem 40, Bat-Yam.</li>
          ...
          <li><strong>Website</strong> refers to Atliz Shino, accessible from http://www.atliz-shino.com</li>    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
        </ul>
